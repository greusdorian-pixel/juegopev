...
/* ══════════════════════════════════════════
   CARD PACKS — 1 card only, harder rates
══════════════════════════════════════════ */
const CARD_PACKS = [
...
/* ══════════════════════════════════════════
   ITEM PACKS — 1-2 items, separate economy
══════════════════════════════════════════ */
const ITEM_PACKS = [
    ...
    >
      ...
      <div style={{padding:"10px 12px 12px"}}>
        ...
        <div style={{display:"flex",gap:8,fontSize:10}}>
          <span style={{color:"#ff7043"}}>⚔ {card.atk}</span>
          <span style={{color:"#42a5f5"}}>🛡 {card.def}</span>
...
export default function App(){
  ...
  // Auto-complete missions → put in pending rewards
  useEffect(()=>{
    let dirty=false;
